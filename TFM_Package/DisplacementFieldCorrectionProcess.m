...
%                 ip.addRequired('iChan',@isnumeric);
        ...
        function output = getDrawableOutput(obj)
            ...
            output(1).defaultDisplayMethod=@(x) VectorFieldDisplay('Color','y');      % Changed from 'b' to 'y' by WIM on 2/5/2019
    ...
    methods (Static)
        ...
        function units = getUnits(varargin)
            units = 'Displacement (Pix)';       % Units stored are actually in pixels. Double-checked. WIM 2/17/2019
%             units = 'Displacement (\mum)';   
        end
    end
end