...
%     disp('================================= Running boussinesqGreens.m -- GPU-enabled ==========================')
    ...
    nanMat=isnan(G);
    if sum(nanMat(:))>0
%         disp('The Boussinesq Greensfunction has been evaluated at zero')
%         disp('To resolve this, the maximal value has been set')
%         G(nanMat) = max(max(G));

%         disp('To resolve this, this value has been set to zero')
        G(nanMat)=0;
    end