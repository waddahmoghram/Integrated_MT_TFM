...
uicontrol(imagePanel,'Style','text',...
    'Position',[210 hPosition 60 20],'Tag','text_imageScaleUnit',...
    'String','Units','HorizontalAlignment','left');
uicontrol(imagePanel,'Style','edit','Position',[280 hPosition 100 20],...
    'String','1','BackgroundColor','white','Tag','edit_imageScaleUnit',...
    'Callback',@(h,event) setScaleUnit(guidata(h)));
...
%% Added by WIM on 2/21/2019
function setScaleUnit(handles)
% grab overall scale factor
scaleUnit=get(handles.edit_imageScaleUnit,'String');
userData = get(handles.figure1,'UserData');
userData.redrawImageFcn(handles,'ScaleUnit',scaleUnit)
%%
