...
%{
    ...
    % Read paper "Quantitative Comparison of Algorithms for Tracking Single Fluorescent Particles" by Cheezum, et al. 2001. 
    % Added by WIM on 2/17/2019. It explains the definition of PSF (Point Source Format)
