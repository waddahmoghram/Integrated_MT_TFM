...
% 
    properties
        ...
        % Added by Waddah Moghram on 2/12/2019
        ScaleUnit = 'Micron';
    end
    methods
...
%             end
        ...
        function applyImageOptions(obj,h)
            ...
            if strcmp(obj.Colorbar,'on')
                ...
                ylabel(hCbar,'Displacement (\mum)',obj.lfont{:});
...
%                 ylabel(hCbar,obj.Units,obj.lfont{:});
            ...
            if ~isempty(obj.CLim),
                ...
                % resolution = 0.215;   % microns/pixel
                % set(hAxes,'CLim',obj.CLim/obj.ScaleFactor* resolution);    % Modified by WIM on 1/9/2019 to calculate displacement in pixels
            else
                set(hAxes,'CLim', [0 1]);
            end
        end
    ...
    methods (Static)
        function params=getParamValidators()
            ...
            %% Added by WIM on 2/22/2019
            params(12).name='ScaleUnit';
            params(12).validator=@ischar;
