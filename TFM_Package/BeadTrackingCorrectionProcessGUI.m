...
% Last Modified by GUIDE v2.5 25-Aug-2019 19:50:35
...
% --- Executes on key press with focus on checkbox_crop and none of its controls.
function checkbox_crop_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to checkbox_crop (see GCBO)
...
function checkbox_crop_CreateFcn(hObject, eventdata, handles)
% hObject    handle to checkbox_crop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
