...
%{
     createHexGridInMask creates grid points in bgdMask with spacing (in pixel).
    ...
    if sizeDiff(1)<0 || sizeDiff(2)<0
        disp('(ERROR in createHexGridInMask.m): something went wrong! Nothing has been done');
        return;
    end
