...
%             output(1).defaultDisplayMethod=@(x) VectorFieldDisplay('Color','r');
    ...
    methods (Static)
        ...
        function funParams = getDefaultParams(owner,varargin)
            ...
            %__________________ Added by Waddah Moghram on 2019-12-16
            funParams.PadRandomZeros = 1;
            funParams.WienerFilter = 1;
            funParams.WienerWindowSize = 3;
            funParams.HanWindow = 1;
