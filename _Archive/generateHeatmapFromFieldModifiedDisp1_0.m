function [umMap,XI,YI] = generateHeatmapFromFieldModifiedDisp1_0(Field,dataPath,band,ummax,cmapmode,w,h,plotQuiver)
...
%     if ~exist(_____,'dir') || ~exist(epsPath,'dir')
%         mkdir(tifPath);
%         mkdir(figPath);
%         mkdir(epsPath);
%     end

    outFiledMap=@(frame) [pwd, filesep, 'dMaps',filesep, 'dMap' numStr(frame) '.mat'];
