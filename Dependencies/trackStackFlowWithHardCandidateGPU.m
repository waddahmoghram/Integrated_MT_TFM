function [v,numTrackedPoints,corLength,sigtValues] = trackStackFlowWithHardCandidateGPU(stack,points,minCorL,varargin)
...
%                 distToMaxV2 = sqrt(sum((locMaxV-ones(size(locMaxV,1),1)*curCandVec).^2,2));
                ...
                error('(ERROR in trackStackFlowWithHardCandidate.m):You have to set hardCandidates!');
            end
        end
