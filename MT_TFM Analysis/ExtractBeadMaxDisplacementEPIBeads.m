...
*** v.2020-02-05 by Waddah Moghram
  ...
  %}
    ...
    title({DisplType, sprintf('Max at (X,Y) = (%0.2f,%0.2f) pix in Frame %d/%d = %0.3f sec', ...
            ...
            sprintf('Max displacement = %0.3f pix = %0.3f %sm @ %0.2f FPS', MaxDisplNetPixels(3), MaxDisplNetMicrons(3), char(181), FrameRate)}, ...
            'FontName', PlotTitleFontName, 'interpreter', 'none')
