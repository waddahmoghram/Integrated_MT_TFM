...
%}   
    ...
    diaryfile = fullfile(CombinedAnalysisPath, 'PlotsDiary.txt');
    diary(diaryfile)
    diary on
...
% Video 1:==================================================================
    ...
    disp('1.1 Finding the bead with the maximum displacement IN PROGRESS')
    ...
    disp('1.1 Finding the bead with the maximum displacement COMPLETE')
...
%% Video 2:==================================================================
    ...
    disp('2.1 Finding the pixel with the maximum displacement IN PROGRESS')    
    ...
    fprintf('Maximum displacement [disp_x, disp_y] =  [%0.3f, %0.3f] %s      \t==> Net displacement [disp_net] = [%0.3f] %s. \n', ...
        MaxDisplNetMicrons(1:2), displUnit, MaxDisplNetMicrons(3) , displUnit)
    disp('2.1 Finding the maximum interpolated with the maximum displacement COMPLETE!')   
...
% Video 3:==================================================================
    ...
    disp('3.1 Finding the maximum displacement vector IN PROGRESS')
    FramesNumEPI = numel(displField);
    FramesDoneNumbers = 1:FramesNumEPI;
    dmaxTMP = nan(FramesNumEPI, 1);
    dmaxTMPindex = nan(FramesNumEPI, 1);    
    ...
    fprintf('Maximum displacement [disp_x, disp_y] =  [%0.3f, %0.3f] %s      \t==> Net displacement [disp_net] = [%0.3f] %s. \n', ...
        MaxDisplNetMicrons(1:2), displUnit, MaxDisplNetMicrons(3) , displUnit)
    disp('3.1 Finding the bead with the maximum displacement COMPLETE')
...
%% Video 4:==================================================================
    ...
    disp('4.1 Finding the pixel with the maximum displacement IN PROGRESS')
    [grid_mat, ~,~,~] = interp_vec2grid(displField(RefFrameNumEPI).pos(:,1:2), displField(RefFrameNumEPI).vec(:,1:2) ,[], reg_grid, InterpolationMethod);
    grid_mat = gpuArray(grid_mat);
    grid_matX = grid_mat(:,:,1);
    grid_matY = grid_mat(:,:,2);
    ...
    fprintf('Maximum displacement [disp_x, disp_y] =  [%0.3f, %0.3f] %s      \t==> Net displacement [disp_net] = [%0.3f] %s. \n', ...
        MaxDisplNetMicrons(1:2), displUnit, MaxDisplNetMicrons(3) , displUnit)
    disp('4.1 Finding the maximum interpolated with the maximum displacement COMPLETE!')   
...
%% Video 5:  find maximum traction stress from grid
    ...
    disp('5.1 Finding the pixel with the maximum traction stress IN PROGRESS')
    ...
    disp('5.1 Finding the pixel with the maximum traction stress COMPLETE!')
