%% Imported on 2020-01-18 from https://www.mathworks.com/matlabcentral/answers/133372-how-to-make-nice-plots
    %{
...
function [fig1,ax1,dcm_obj] = MakeOpenFigPretty()
 set(0,'defaultfigurecolor',[1 1 1]) % white background
 set(0,'defaultaxesfontname',PlotsFontName) % beautify the axes a bit
