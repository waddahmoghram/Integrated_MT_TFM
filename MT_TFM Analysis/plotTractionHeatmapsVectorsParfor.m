...
%     if useGPU, grid_mat = gather(grid_mat);displVecGridNorm = gather(displVecGridNorm); end        
    ...
    figAxesHandle.Position(1) = figAxesHandle.Position(1) - colorbarHandle.Position(3);

    Location = imgSize - [3,3];       
    ...
    Location = imgSize.* [0, 1] + [3,-3];                  % bottom right corner
