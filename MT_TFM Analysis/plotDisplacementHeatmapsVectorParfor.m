function [CurrentFramePlot] = plotDisplacementHeatmapsVectorParfor(MD_EPI,displFieldMicron,CurrentFrame, QuiverScaleToMax, QuiverColor, colormapLUT_TxRed, ...
...
%     if useGPU, grid_mat = gather(grid_mat);displVecGridNorm = gather(displVecGridNorm); end
    ...
    sBar = scalebar(figAxesHandle,'ScaleLength',ScaleLength_EPI, 'ScaleLengthRatio',ScaleMicronPerPixel_EPI, 'color', colormapLUT(end,:), ...
